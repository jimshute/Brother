...
angular.module('app.directive').directive('pager', function () {
  return {
    ...
    template: [
      '<ul class="pagination">',
      '<li class="{{enableFirst()}}"><a ng-click="switchPage(1)" aria-label="First" href="#"><span aria-label="true">«</span></a></li>',
      '<li class="{{enablePrevious()}}"><a ng-click="switchPage(current-1)" aria-label="Previous" href="#"><span aria-label="true">&lt;</span></a></li>',
      '<li class="{{showPreGroup()}}"><a ng-click="switchPage(first - 1)" href="#">...</a></li>',
      '<li class="{{item === current ? \'active\' : \'\'}}"  ng-repeat="item in items"><a ng-click="switchPage(item)"href="#">{{item}}</a></li>',
      '<li class="{{showNextGroup()}}"><a ng-click="switchPage(first + maxShowPages)" href="#">...</a></li>',
      '<li class="{{enableNext()}}"><a ng-click="switchPage(current+1)" aria-label="Next" href="#"><span aria-label="true">&gt;</span></a></li>',
      '<li class="{{enableLast()}}"><a ng-click="switchPage(total)" aria-label="Last" href="#"><span aria-label="true">»</span></a></li>',
      '</ul>',
    ].join(''),
    transclude: true,
    scope: {
